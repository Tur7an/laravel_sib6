                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Data Jenis Produk : {{$jenis_produk}}</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
...
// codingan diatas memanggil variable produkData yang dikirim compact dari
//DashboardController
...
// map adalah fungsi untuk mengurutkan data
});
