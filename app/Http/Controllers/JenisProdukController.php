<?php
// jenis produk dan produk akan dibuat mengunakan
...
use DB;
// library DB ini digunakan ketika mengunakan penulisan Query Builder
...
class JenisProdukController extends Controller
{
    ...
    public function index()
    {
        ...
        // varibale jenis ini mendeklarasikan table yang diambil dari model
    ...
    {
        //menambahkan data dengan query builder
